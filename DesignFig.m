...
function [] = GenerateCode(~,~)
	disp(strcat('fig_handle=figure(',char(39),'Units',char(39),',',char(39),'pixels',char(39),',',char(39),'Position',char(39),',',mat2str(figure_position),',',char(39),'Color',char(39),',',char(39),'w',char(39),');'))
	disp('clf(fig_handle);')
	for i = 1:length(allrect)
		disp(strcat('axes_handles(',mat2str(i),')=axes(',char(39),'Units',char(39),',',char(39),'pixels',char(39),',',char(39),'Position',char(39),',',mat2str(getPosition(allrect(i).h)),');'))
	end
