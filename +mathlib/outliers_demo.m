...
% Now attempt to find the outliers using 'outliers' function
% -------------------------------------------------------------------------

[mu,S,RD,chi_crt]=outliers(X);
...
% 'outliers' for additional information.

% To improve detection accuracy you can also supply an estimate of
% the number of outliers in X (n_out) as [...]=outliers(X,n_out)
