function	[dip,xl,xu, ifault, gcm, lcm, mn, mj] = HartigansDipTest(X)
...
%
% HartigansDipTest, like DIPTST, does the dip calculation for an ordered vector X using
...
% with modifications by Srinivas Gorur-Shandilya
% I stripped away a bunch of useless checks and removed some
